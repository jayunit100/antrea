...
Then, you can run the following commands. This will install Antrea as a Windows service. Please ensure [nssm](https://nssm.cc/)
is on your machine, which is a handy tool to manage service on Windows. NOTE: `<KubernetesVersion>`, `<KubeconfigPath>`
and `<KubeletKubeconfigPath>` should be filled by you. E.g.
```powershell
$KubernetesVersion="v1.20.4"
$KubeConfig="C:/Users/Administrator/.kube/config" # admin kubeconfig
$KubeletKubeConfig="C:/etc/kubernetes/kubelet.conf"
```
...
$KubeletKubeConfig="<KubeletKubeconfigPath>"
$KubernetesHome="c:/k"
